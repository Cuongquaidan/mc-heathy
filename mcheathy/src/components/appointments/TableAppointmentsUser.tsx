...
function TableAppointmentsUser() {
    ...
    const { data, error } = useFetchData<{
        ...
        `${process.env.NEXT_PUBLIC_API_URL}/appointments/getAppointmentByUserId?page=${page}&limit=${limit}`,
        "Fetch data failed",
        accessToken || " "
    );
    useEffect(() => {
...
export default TableAppointmentsUser;
