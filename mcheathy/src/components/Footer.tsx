            ...
            <div className=" bg-lightBlue dark:bg-black">
                <div className="grid grid-cols-2 gap-20 p-10">
                    <div className="font-bold">
                        ...
                        <br></br>
                        Thank you for choosing MCHealthy for your healthcare
                        needs. We sincerely appreciate your trust in our
                        services. Our dedicated team strives to provide you with
                        exceptional care and support, ensuring your experience
                        is as comfortable as possible. Your feedback is
                        invaluable to us, and we are committed to continuously
                        improving our services. We look forward to serving you
